...
namespace YCM.CLO.DTO
{
	public class VwSecurityDto
    {
        ...
        public IEnumerable<LoanAttributeOverrideDto> LoanAttributeOverrides { get; set; }
        public string SecurityLastUpdatedOn { get; set; }
        public string SecurityLastUpdatedBy { get; set; }
        public bool? HasPositions { get; set; }

        public string SecurityName => SecurityCode + " | " + Issuer + " | " + Facility;
        public void SetSearchText()
        {
            LoanAttributeOverrides.ToList().ForEach(e => e.SetSearchText(this));
        }
    }
}
