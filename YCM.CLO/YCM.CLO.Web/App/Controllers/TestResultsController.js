...
(function (Application) {
    ...
    (function (Controllers) {
        var TestResultsController = (function () {
            function TestResultsController(uiService, dataService, $rootScope, ngTableParams, $filter, $window, $interval) {
                var _this = this;
                ...
                this.downloadSummaries = function (fundId) {
                    var vm = _this;
                    vm.dataService.downloadSummaries();
                };
                ...
                //vm.activeView     = 'testresults';
                vm.window = $window;
                vm.filter = $filter;
                vm.interval = $interval;
                vm.rootScope.$emit('onActivated', 'testresults');
            ...
            TestResultsController.prototype.getAssetParRestrictions = function (fieldName, fundId) {
                var vm = this;
                var fieldFundRestrictions = vm.fundRestrictions.filter(function (fr) {
        ...
        TestResultsController.$inject = ["application.services.uiService", "application.services.dataService", "$rootScope", 'NgTableParams', '$filter', '$window', '$interval'];
        Controllers.TestResultsController = TestResultsController;
        angular.module("app").controller("application.controllers.testResultsController", TestResultsController);
    })(Controllers = Application.Controllers || (Application.Controllers = {}));
})(Application || (Application = {}));
//# sourceMappingURL=TestResultsController.js.map