...
(function (Application) {
    ...
    (function (Controllers) {
        var AddNewSecurityController = (function () {
            function AddNewSecurityController(dataService, $rootScope, modalService, ngTableParams, $filter, timeOutService) {
                var _this = this;
            ...
            return AddNewSecurityController;
        }());
        AddNewSecurityController.$inject = ["application.services.dataService", "$rootScope", '$modal', 'NgTableParams', '$filter', '$timeout'];
        Controllers.AddNewSecurityController = AddNewSecurityController;
        angular.module("app").controller("application.controllers.addNewSecurityController", AddNewSecurityController);
    })(Controllers = Application.Controllers || (Application.Controllers = {}));
})(Application || (Application = {}));
//# sourceMappingURL=AddNewSecurityController.js.map