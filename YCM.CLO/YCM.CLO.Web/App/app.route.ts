module Application {
    ...
    export class Routes {
		...
		static configureRoutes($locationProvider: any, $routeProvider: ng.route.IRouteProvider) {
            ...
            $routeProvider.when("/top10Bottom10", { controller: "application.controllers.top10Bottom10Controller", templateUrl: pageOptions.appBasePath + "/App/Views/top10bottom10.html?v="+pageOptions.version, controllerAs: "top10bottom10" })
                .when("/positions", { controller: "application.controllers.positionsController", templateUrl: () => {
                ...
                .when("/dayoverchanges", { controller: "application.controllers.DayOverChangesController", templateUrl: pageOptions.appBasePath + "/App/Views/DayOverChanges.html", controllerAs: "dayoverchanges" });
                ;
