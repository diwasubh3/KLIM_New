        ...
        var HttpWrapperFactory = (function () {
            function HttpWrapperFactory($http, $q) {
                ...
                this.getData = function (url) {
                    ...
                    _this.httpService.get(url, { timeout: 360000, headers: { 'Cache-Control': 'no-cache' } }).then(function (d) {
                ...
                this.postData = function (url, data) {
                    var deferred = _this.$q.defer();
                    _this.httpService.post(url, data).then(function (d) {
                        deferred.resolve(d.data);
                    }).catch(function () {
                        deferred.reject();
                    });
                ...
                this.deleteData = function (url) {
                    var deferred = _this.$q.defer();
                    _this.httpService.delete(url).then(function (d) {
                        deferred.resolve(d.data);
                    }).catch(function () {
                        deferred.reject();
                    });
