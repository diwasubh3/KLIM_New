...
{
    public class vw_SecurityFundMap : EntityTypeConfiguration<vw_SecurityFund>
    {
        public vw_SecurityFundMap()
        {
            // Primary Key
            this.HasKey(t => new { t.SecurityId, t.SecurityCode, t.IsFloating, t.IssuerId, t.OrigSecurityCode, t.OrigBBGId, t.OrigIsFloating, t.FundId, t.FundCode });
            ...
            this.ToTable("vw_SecurityFund", "CLO");
