UPDATE [DataMarts].[dbo].[WsoDatasetQuery]
SET Sql = 'SELECT  tblAssets.AssetId ,
        ...
        tblAssets.UserString11 ,
        tblAssets.UserString12 ,
        tblAssets.UserString13 ,
        tblAssets.UserString14 ,
        tblAssets.UserString15 ,
        tblAssets.UserString16 ,
        ...
        tblAssets.UserPercentage6 ,
		tblAssetsUDFs.CapitalizedInterestOrig,
		tblAssets.UserString18 SnPAssetRecoveryRating
FROM    tblAssets
