...
$runCommand = "C:\Application\AnalystLinkage\YCM.CLO.AnalystLinkage.exe"
...
try
{
	...
	$returnMessage = C:\Application\AnalystLinkage\YCM.CLO.AnalystLinkage.exe
