...
$ccEmail = ""
$subject = "CLO Purchase & Sale Report - $fileDate"
$body = "Attached CLO Purchase & Sale Report."
$attachment = (get-childitem "\\KL-NY-DC01\Generate\Firm Reporting\Purchase & Sale\\CLOPurchaseSalewithComments*$fileDate*").fullname 
